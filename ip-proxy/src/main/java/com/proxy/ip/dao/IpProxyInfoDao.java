...
public interface IpProxyInfoDao extends JpaRepository<IpProxyInfo, Serializable>, JpaSpecificationExecutor<IpProxyInfo> {
	...
	@Modifying
	@Query(value = "  delete from  ip_proxy_info  where delete_flag =:deleteFlag and  create_time < :longTime ", nativeQuery = true)
	void deleteAllByDeleteFlag(@Param("deleteFlag") Integer deleteFlag, @Param("longTime") String longTime);
